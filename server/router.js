...
const router = (app) => {
 // pass the express app in
  ...
  app.get('/getNameD', controllers.getNameD);
  app.get('/findByName', controllers.searchName);
  app.get('/findByNameDog', controllers.updateLastD);
  ...
  app.post('/dog', controllers.setNameDog);

    // When someone POSTS to /updateLast, call controllers.updateLast
  app.post('/updateLast', controllers.updateLast);
  app.post('/updateLastDog', controllers.updateLastD);
};

// export the router functiapp.
